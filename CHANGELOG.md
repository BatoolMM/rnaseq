...
- [PR #1792](https://github.com/nf-core/rnaseq/pull/1792) - Always emit a strand-agnostic `<sample>.bigWig`; skip the per-strand bigWigs for unstranded libraries where they carry no biological meaning ([#1275](https://github.com/nf-core/rnaseq/issues/1275))
