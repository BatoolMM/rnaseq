...
- [PR #XXXX](https://github.com/nf-core/rnaseq/pull/XXXX) - Switch the default `--ribo_database_manifest` to SortMeRNA's recommended `smr_v4.3_default_db.fasta.gz` (SILVA 138 + Rfam) hosted as a per-variant asset on the SortMeRNA [v4.3.7 release](https://github.com/sortmerna/sortmerna/releases/tag/v4.3.7), replacing the eight SILVA 119-based FASTAs from `biocore/sortmerna/v4.3.4`. Unblocks [#1354](https://github.com/nf-core/rnaseq/issues/1354) now that upstream has split the database archive ([sortmerna/sortmerna#458](https://github.com/sortmerna/sortmerna/issues/458))
